export default function GabrielHailePage() {
  const member = {
    name: "Gabriel",
    fullName: "Gabriel Haile",
    ...
    fullBio: "Gabriel specializes in developing explosive power, speed, and endurance for athletes across all sports. With a background in competitive sports and advanced biomechanics, he designs programs that optimize performance while preventing injuries. His data-driven approach ensures measurable progress for every client.",
    specialties: [
