export default function SaraBekelePage() {
  const member = {
    name: "Sara",
    ...
    fullBio: "Sara combines evidence-based nutrition science with practical meal planning to help clients achieve their health goals. Whether you're looking to lose weight, build muscle, or improve overall wellness, she creates customized nutrition strategies that fit your lifestyle. Her holistic approach considers not just what you eat, but how food affects your energy, performance, and well-being.",
    specialties: [
      "Sports Nutrition",
      "Weight Management",
      "Meal Planning",
